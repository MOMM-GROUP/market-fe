...
const useOfFunds = [
  {
    ...
    amount: "$125K",
    description:
      "Primary focus. Core engineering & Product team to build the TRUST protocol, MARKET platform & our proprietary data scraping and normalization engine",
  },
  {
    category: "Brand Partnerships & Community Growth",
    percentage: 25,
    amount: "$62K",
    description:
      "Onboard our first cohort of ethical brand partners and conscious consumers through targeted outreach and strategic marketing.",
  },
  {
    ...
    amount: "$37K",
    description:
      "Essential costs including cloud hosting, database services, data scraping tools, and node infrastructure.",
  },
  {
              ...
              return (
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="text-3xl font-bold mb-2" style={{ color: highlight.color }}>
                        {highlight.value}
                      </div>
      ...
      <section className="py-20" style={{ backgroundColor: "#F8FAFC" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8 mb-16">
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: "#475569" }}>
              We're building the infrastructure for verifiable commerce. Our fundraising campaign on Wefunder allows you
              to invest in the future of ethical shopping and become part of the solution.
            </p>
          </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl">
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p style={{ color: "#475569" }}>Join a community of ethical investors and help scale global impact</p>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  <a
                    ...
                    className="w-full text-white px-6 py-4 rounded-lg font-semibold transition-colors flex items-center justify-center"
                    ...
                    <div className="space-y-6">
                      <div>
                        <div className="flex items-center space-x-4 mb-4">
                          <div className="text-4xl font-bold" style={{ color: "#0D9488" }}>
                            {metric.value}
                          </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-xl font-bold" style={{ color: "#0D9488" }}>
                      {investmentTerms.target}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm" style={{ color: "#64748B" }}>
                  ...
                  <div key={index} className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-right">
                        <div className="font-bold" style={{ color: "#0D9488" }}>
                          {fund.percentage}%
                        </div>
                        <div className="text-sm" style={{ color: "#64748B" }}>
                          {fund.amount}
