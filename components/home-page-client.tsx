      ...
      <section className="py-32 px-4 text-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
        <div className="center-content max-w-5xl">
          <h1 className="text-5xl md:text-7xl font-bold mb-8 text-balance">
            Shop Your Values, Own Your Impact - MOMM Marketplace
          </h1>
          <p className="text-xl md:text-2xl mb-6 leading-relaxed max-w-3xl mx-auto font-semibold">
            The Era of the Billionaire is Over. The money exists. It's just going to the wrong people.
          </p>
          <p className="text-lg md:text-xl mb-12 leading-relaxed max-w-3xl mx-auto">
            Join the revolutionary marketplace where your purchases work for you. Track boycotts, verify ethical claims,
            earn profit sharing, and vote with your dollar. Stop funding billionaires. Start funding yourself.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8 mb-16">
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: "#475569" }}>
              We're not just building another shopping app. These groundbreaking features will transform how you
              discover, buy, and interact with products throughout their entire lifecycle.
            </p>
          </div>
                  ...
                  <div className="bg-white p-8 rounded-2xl shadow-xl border-2" style={{ borderColor: feature.color }}>
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                      ...
                      <div className="relative">
                        ...
                        <div
                          className="absolute inset-0 rounded-xl border-2 border-dashed opacity-50"
      ...
      <section className="py-20" style={{ backgroundColor: "#F1F5F9" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8 mb-16">
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: "#475569" }}>
              Your personal rewards vault. More than just cash back - it's a flexible fund that you control, designed
              for real-life needs and opportunities.
            </p>
          </div>
          ...
          {/* Vault Visualization */}
          <div
            className="bg-gradient-to-br p-8 rounded-2xl shadow-xl text-white max-w-4xl mx-auto"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-2 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Shopping products. Build Profit.</p>
                <Link href="/early-access">
            ...
            <Card className="border-2 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Help build the platform. Profit when we profit.</p>
                <Link href="/contributors">
